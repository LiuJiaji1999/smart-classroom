...
class ssMatch(object):
    ...
    def aloneSeat(self,seat,seatnum,seatsort):
        ...
        for i in range(seatnum):  # 划分seatnum个座位
            x += seat_dis1_x
            y += seat_dis1_y
            x = int(x)
            y = int(y)
...
# #单张图片
test = ssMatch('img/keda_20223241103504484.jpg' ,'keda_classroom1.json','npy/keda_20223241103504484.npy','final_img/keda_20223241103504484.jpg')

match_json_data = test.match('match/keda_classroom1.json')
print('人座匹配结果：',match_json_data)
print('success')
