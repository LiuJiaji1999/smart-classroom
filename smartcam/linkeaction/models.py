...
class SinglePersonSVM(object):
    ...
    def __init__(self, weights_path=None):
        if weights_path is not None:
            ...
            self.model = svm.SVC(C=0.001,gamma='auto',decision_function_shape='ovo',kernel='poly',degree=1)
    ...
    def predict(self, x):
        ...
        Args:
            x (list): 25x3 pose (or empty list)   25X2
